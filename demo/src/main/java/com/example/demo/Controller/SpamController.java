...
public class SpamController {
    ...
    // New method to unblock a phone number
    @DeleteMapping("/unblock")
    public String unblockNumber(@RequestParam("phone_number") String phoneNumber) {
        return spamService.unblockNumber(phoneNumber);
    }
